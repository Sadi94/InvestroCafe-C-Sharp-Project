...
{
    public partial class CODInvest : Form
    {
        ...
        private void CODInvest_Load(object sender, EventArgs e)
        {
            //connection
        ...
        private void CODInvest_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            // gridView.....
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /////
            SqlConnection con = new SqlConnection(cs);
            string query = "DELETE FROM COD WHERE NID=@Nid";
